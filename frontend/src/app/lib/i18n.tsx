...
const translations: Translations = {
  ...
  "credit.subtitle": { en: "Manage available customer credit and transactions", es: "Administrar cupo disponible y transacciones de clientes" },
  "credit.totalOut": { en: "Available Credit", es: "Cupo Disponible" },
  "credit.activeCredits": { en: "Clients With Credit", es: "Clientes con Cupo" },
  "credit.totalClients": { en: "Total Clients", es: "Total de Clientes" },
  "credit.balances": { en: "Client Available Credit", es: "Cupo Disponible de Clientes" },
  ...
  "credit.outstanding": { en: "Clients with available credit", es: "Clientes con cupo disponible" },
  "credit.registered": { en: "Registered in system", es: "Registrados en el sistema" },
  "credit.due": { en: "Available Credit", es: "Cupo Disponible" },
  "credit.clear": { en: "No Credit", es: "Sin Cupo" },
  "credit.added": { en: "Credit reloaded", es: "Cupo recargado" },
  "credit.noTransactions": { en: "No credit transactions yet", es: "No hay transacciones de crédito aún" },
  "credit.addTitle": { en: "Reload Credit", es: "Recargar Cupo" },
  "credit.deductTitle": { en: "Deduct Credit", es: "Descontar Cupo" },
  "credit.currentBalance": { en: "Available Credit", es: "Cupo Disponible" },
  "credit.amount": { en: "Amount", es: "Monto" },
  "credit.newBalance": { en: "New Available Credit", es: "Nuevo Cupo Disponible" },
